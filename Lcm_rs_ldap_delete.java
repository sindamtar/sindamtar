...
public class Lcm_rs_ldap_delete implements Processor {
	...
	public void process(Exchange exchange) throws Exception,JSONException {
				...
				ctx.put("status_code_ldap_delete", json.get("status_code"));
				ctx.put("status_description_ldap_delete", json.get("status_description")); 
