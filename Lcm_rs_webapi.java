...
public class Lcm_rs_webapi implements Processor {
	@Override 
	public void process(Exchange exchange) throws Exception,JSONException {
				...
				ctx.put("status_code_webapi", json.get("status_code"));
				ctx.put("status_description_webapi", json.get("status_description")); 
